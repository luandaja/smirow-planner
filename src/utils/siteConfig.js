module.exports = {
  ...
  author: 'Smirow', // Author for RSS author segment and SEO schema
  authorUrl: '#', // URL used for author and publisher schema, can be a social profile or other personal site
  userTwitter: '@luandaja94', // Change for Twitter Cards
  shortTitle: 'Smirow Planner', // Used for App manifest e.g. Mobile Home Screen
  ...
  copyright: 'Copyright © 2019 Smirow', // Copyright string for the RSS feed
}
